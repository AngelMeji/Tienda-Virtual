...
<body class="bg-black text-white font-sans">
  ...
  <main class="px-10 py-12 max-w-5xl mx-auto space-y-8">
    ...
    <div class="text-sm space-y-1">
      <p><span class="font-semibold">Número de pedido:</span> 2</p>
      <p><span class="font-semibold">Total a pagar:</span> $4.100.000</p>
    ...
    <div class="space-y-8">
      ...
      <div class="flex items-center space-x-6">
        <img src="4.png" alt="Producto 1" class="w-48 rounded-md" />
        <div class="flex-1">
      ...
      <!-- Producto 2 -->
      <div class="flex items-center space-x-6">
        <img src="4.png" alt="Producto 2" class="w-48 rounded-md" />
        <div class="flex-1">
